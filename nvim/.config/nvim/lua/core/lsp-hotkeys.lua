...
utils.nnoremap("<Leader>fn", ":lua require'plugins.telescope-config'.Search('< NeovimRC >' , '~/.config/nvim/' ) <CR>")
utils.nnoremap("<Leader>fr", ":lua require'plugins.telescope-config'.Search('< swayRC >' , '~/.config/sway' ) <CR>")

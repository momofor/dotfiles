...
utils.nnoremap("<leader>ds", require("telescope.builtin").lsp_document_symbols)
utils.nnoremap("<leader>ws", require("telescope.builtin").lsp_dynamic_workspace_symbols)

...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'lsp_signature.nvim', 'barbar.nvim', 'lsp-rooter.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lualine.nvim', 'markdown-preview.nvim', 'Comment.nvim', 'telescope.nvim', 'nvim-colorizer.lua', 'nvim-lsp-ts-utils', 'nvim-tree.lua', 'crates.nvim', 'formatter.nvim', 'gitsigns.nvim', 'trouble.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

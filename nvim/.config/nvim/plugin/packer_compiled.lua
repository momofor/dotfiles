...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'trouble.nvim', 'kommentary', 'lualine.nvim', 'markdown-preview.nvim', 'nvim-colorizer.lua', 'nvim-lsp-ts-utils', 'nvim-tree.lua', 'telescope.nvim', 'crates.nvim', 'formatter.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

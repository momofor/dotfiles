...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'gitsigns.nvim', 'lualine.nvim', 'nvim-lsp-ts-utils', 'Comment.nvim', 'toggleterm.nvim', 'barbar.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

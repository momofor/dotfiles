...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'toggleterm.nvim', 'nvim-lsp-ts-utils', 'barbar.nvim', 'null-ls.nvim', 'Comment.nvim', 'parinfer-rust', 'yuck.vim', 'lualine.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

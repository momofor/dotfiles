...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'kommentary', 'lualine.nvim', 'markdown-preview.nvim', 'nvim-lsp-ts-utils', 'nvim-tree.lua', 'crates.nvim', 'gitsigns.nvim', 'formatter.nvim', 'telescope.nvim', 'nvim-colorizer.lua', 'trouble.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

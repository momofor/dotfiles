...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lsp-ts-utils', 'crates.nvim', 'formatter.nvim', 'gitsigns.nvim', 'kommentary', 'markdown-preview.nvim', 'vimtex'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'barbar.nvim', 'trouble.nvim', 'lualine.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'delimitMate'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-tree.lua', 'vim-indent-guides', 'lsp_signature.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]

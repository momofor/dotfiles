...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'crates.nvim', 'gitsigns.nvim', 'telescope.nvim', 'kommentary', 'trouble.nvim', 'nvim-colorizer.lua', 'nvim-lsp-ts-utils', 'nvim-tree.lua', 'markdown-preview.nvim', 'formatter.nvim', 'lualine.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

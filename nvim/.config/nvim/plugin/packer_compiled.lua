...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'markdown-preview.nvim', 'nvim-lsp-ts-utils', 'vimtex', 'crates.nvim', 'formatter.nvim', 'gitsigns.nvim', 'kommentary'}, { event = "BufRead *" }, _G.packer_plugins)]]

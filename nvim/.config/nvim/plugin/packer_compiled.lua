...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'null-ls.nvim', 'barbar.nvim', 'lualine.nvim', 'TrueZen.nvim', 'indent-blankline.nvim', 'gitsigns.nvim', 'Comment.nvim', 'nvim-lsp-ts-utils', 'toggleterm.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-surround', 'registers.nvim', 'delimitMate'}, { event = "InsertEnter *" }, _G.packer_plugins)]]

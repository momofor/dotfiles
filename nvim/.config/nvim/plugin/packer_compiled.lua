...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lsp-ts-utils', 'barbar.nvim', 'toggleterm.nvim', 'indent-blankline.nvim', 'Comment.nvim', 'lualine.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

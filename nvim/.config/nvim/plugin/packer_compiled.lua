...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-lsp-ts-utils', 'nvim-tree.lua', 'gitsigns.nvim', 'null-ls.nvim', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'lsp-rooter.nvim', 'lsp_signature.nvim', 'trouble.nvim', 'vim-indent-guides'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'dashboard-nvim', 'lualine.nvim', 'telescope-file-browser.nvim', 'telescope.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]

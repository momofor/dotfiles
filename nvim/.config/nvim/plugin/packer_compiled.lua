...
_G.packer_plugins = {
  ...
  catppuccin = {
    config = { "\27LJ\2\n1\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\22plugins.catpuccin\frequire\0" },
    loaded = true,
    path = "/home/momofor/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  ["cmp-dictionary"] = {
    loaded = true,
    path = "/home/momofor/.local/share/nvim/site/pack/packer/start/cmp-dictionary",
    url = "https://github.com/uga-rosa/cmp-dictionary"
  },
  ["cmp-latex-symbols"] = {
    loaded = true,
    path = "/home/momofor/.local/share/nvim/site/pack/packer/start/cmp-latex-symbols",
  ...
  ["dressing.nvim"] = {
    loaded = true,
    path = "/home/momofor/.local/share/nvim/site/pack/packer/start/dressing.nvim",
  ...
  ["hop.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/momofor/.local/share/nvim/site/pack/packer/opt/hop.nvim",
  ...
  ["inc-rename.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/momofor/.local/share/nvim/site/pack/packer/opt/inc-rename.nvim",
  ...
  ["kitty-runner.nvim"] = {
    ...
    loaded = true,
    path = "/home/momofor/.local/share/nvim/site/pack/packer/start/kitty-runner.nvim",
  ...
  ["mason.nvim"] = {
    ...
    loaded = true,
    path = "/home/momofor/.local/share/nvim/site/pack/packer/start/mason.nvim",
  ...
  ["nvim-cmp"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/momofor/.local/share/nvim/site/pack/packer/opt/nvim-cmp",
  ...
  ["nvim-surround"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/momofor/.local/share/nvim/site/pack/packer/opt/nvim-surround",
  ...
  ["nvim-treesitter-context"] = {
    loaded = true,
    path = "/home/momofor/.local/share/nvim/site/pack/packer/start/nvim-treesitter-context",
...
try_loadstring("\27LJ\2\n1\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\22plugins.catpuccin\frequire\0", "config", "catppuccin")
...
vim.cmd [[au LspAttach * ++once lua require("packer.load")({'inc-rename.nvim', 'null-ls.nvim'}, { event = "LspAttach *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-lsp-ts-utils', 'gitsigns.nvim', 'lualine.nvim', 'Comment.nvim', 'toggleterm.nvim', 'barbar.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'alpha-nvim', 'hop.nvim', 'trouble.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'delimitMate', 'nvim-surround'}, { event = "InsertEnter *" }, _G.packer_plugins)]]

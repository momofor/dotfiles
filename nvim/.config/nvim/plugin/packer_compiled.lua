...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'barbar.nvim', 'TrueZen.nvim', 'Comment.nvim', 'nvim-lsp-ts-utils', 'null-ls.nvim', 'lualine.nvim', 'toggleterm.nvim', 'gitsigns.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'delimitMate', 'registers.nvim', 'vim-surround'}, { event = "InsertEnter *" }, _G.packer_plugins)]]

...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lsp-ts-utils', 'crates.nvim', 'telescope.nvim', 'gitsigns.nvim', 'kommentary', 'lualine.nvim', 'markdown-preview.nvim', 'formatter.nvim', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'delimitMate', 'vim-surround'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'barbar.nvim', 'trouble.nvim', 'lsp-rooter.nvim', 'lsp_signature.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-startify'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-tree.lua', 'vim-indent-guides'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]

...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'formatter.nvim', 'gitsigns.nvim', 'kommentary', 'lualine.nvim', 'telescope.nvim', 'markdown-preview.nvim', 'trouble.nvim', 'nvim-colorizer.lua', 'nvim-lsp-ts-utils', 'nvim-tree.lua', 'crates.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

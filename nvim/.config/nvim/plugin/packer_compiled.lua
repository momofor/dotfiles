...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-lsp-ts-utils', 'nvim-tree.lua', 'formatter.nvim', 'lualine.nvim', 'Comment.nvim', 'gitsigns.nvim', 'telescope.nvim', 'markdown-preview.nvim', 'trouble.nvim', 'crates.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'barbar.nvim', 'lsp-rooter.nvim', 'lsp_signature.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]

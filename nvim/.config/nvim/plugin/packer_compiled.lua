...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lualine.nvim', 'indent-blankline.nvim', 'gitsigns.nvim', 'parinfer-rust', 'toggleterm.nvim', 'null-ls.nvim', 'Comment.nvim', 'nvim-lsp-ts-utils', 'yuck.vim', 'barbar.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

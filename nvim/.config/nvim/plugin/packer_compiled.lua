...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lualine.nvim', 'barbar.nvim', 'indent-blankline.nvim', 'Comment.nvim', 'gitsigns.nvim', 'toggleterm.nvim', 'nvim-lsp-ts-utils'}, { event = "BufRead *" }, _G.packer_plugins)]]

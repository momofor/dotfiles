...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-lsp-ts-utils', 'TrueZen.nvim', 'null-ls.nvim', 'barbar.nvim', 'lualine.nvim', 'toggleterm.nvim', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'delimitMate', 'vim-surround', 'registers.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]

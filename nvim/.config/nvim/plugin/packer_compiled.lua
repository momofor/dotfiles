...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'trouble.nvim', 'lualine.nvim', 'barbar.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'vim-indent-guides', 'nvim-tree.lua'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'kommentary', 'markdown-preview.nvim', 'vimtex', 'nvim-lsp-ts-utils', 'crates.nvim', 'formatter.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

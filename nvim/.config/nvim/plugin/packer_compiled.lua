...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-tree.lua', 'Comment.nvim', 'gitsigns.nvim', 'null-ls.nvim', 'nvim-colorizer.lua', 'nvim-lsp-ts-utils'}, { event = "BufRead *" }, _G.packer_plugins)]]

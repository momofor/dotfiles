...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-tree.lua', 'crates.nvim', 'formatter.nvim', 'kommentary', 'lualine.nvim', 'trouble.nvim', 'telescope.nvim', 'gitsigns.nvim', 'nvim-colorizer.lua', 'markdown-preview.nvim', 'nvim-lsp-ts-utils'}, { event = "BufRead *" }, _G.packer_plugins)]]

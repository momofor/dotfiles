...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'parinfer-rust', 'nvim-lsp-ts-utils', 'Comment.nvim', 'null-ls.nvim', 'lualine.nvim', 'yuck.vim', 'barbar.nvim', 'indent-blankline.nvim', 'toggleterm.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]

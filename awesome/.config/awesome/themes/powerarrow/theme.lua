...
theme.titlebar_bg_focus                         = "#2E3440"
theme.titlebar_bg_normal                        = "#2E3440"
theme.titlebar_fg_focus                         = "#2E3440"
...
function theme.at_screen_connect(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = dpi(16), bg = "#2E3440", fg = theme.fg_normal })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            --arrow("#343434", "#777E76"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#4B696D"),
            --arrow("#4B696D", "#4B696D"),

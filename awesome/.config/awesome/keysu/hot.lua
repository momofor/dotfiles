...
-- }}}
globalkeys = my_table.join( -- Take a screenshot
-- https://github.com/lcpz/dots/blob/master/bin/screenshot
    ...
    awful.key({altkey, "Control"}, "l", function() os.execute(scrlocker) end,
              {description = "lock screen", group = "hotkeys"}), -- Hotkeys
    ...
    awful.key({altkey, "Shift"}, "k",
        ...
        description = "increase current client height factor",
        group = "layout"
    }),
                 awful.key({altkey, "Shift"}, "j",
                           function() awful.client.incwfact(0.025) end, {
        description = "decrease current client height factor",
        group = "layout"
    }),
    ...
    -- pipewire volume control
                 awful.key({modkey}, "Up", function() volume_widget:inc(5) end,
    ...
    -- User programs
                 ...
                 awful.key({modkey}, "i",
                           function() awful.spawn.with_shell("inkscape") end,
        ...
        awful.spawn("rofi -show drun -font \"Dejavu Sans 14\" ")
                 ...
                 awful.key({modkey}, "g",
                           function() awful.spawn.with_shell("gimp") end,
                           {description = "run inkscape", group = "launcher"}),
                 awful.key({modkey}, "w", function()
        awful.spawn.with_shell("rofi -show window")
    end, {description = "run pcmanfm", group = "launcher"}),
                 awful.key({modkey}, "z",
                           function() awful.spawn.with_shell("zathura") end,
                           {description = "run zathura", group = "launcher"}),
                 awful.key({modkey}, "e", function()
        awful.spawn.with_shell(term_exec .. "nvim ~/.config/awesome/rc.lua")
    end, {description = "run zathura", group = "launcher"}),
                 awful.key({modkey}, "c", function() awful.spawn("luakit") end,
                           {
        description = "run luakit browser",
        group = "launcher"
    }), awful.key({modkey, "Control"}, "l", function()
        awful.spawn.with_shell("setxkbmap -layout " .. ChangeLayout())
    end, {description = "run change layout keyboard", group = "launcher"}),

...
\newcommand{\solution}[1]{
	\begin{tcolorbox}[colback=green!5!white,colframe=green!50!black,title=Solution]
		#1
	\end{tcolorbox}}
\newcommand{\preuve}[1]{
	\begin{tcolorbox}[colback=magenta!5!white,colframe=magenta!50!black,title=Preuve]
		#1
	\end{tcolorbox}}

\newcommand{\exercice}[1]{
	\begin{tcolorbox}[colback=magenta!5!white,colframe=magenta!50!black,title=Exercice]
		#1
	\end{tcolorbox}}
